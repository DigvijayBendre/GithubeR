            ...
            <Slider {...storysettings}>
                <div data-bs-toggle="modal" data-bs-target="#Modalstory" className="card w125 h200 d-block border-0 shadow-none rounded-xxxl bg-dark overflow-hidden mb-3 mt-0 me-3">
                    <div className="card-body d-block p-3 w-100 position-absolute bottom-0 text-center">
                        <span className="btn-round-lg bg-white"><a href="/defaultstorie"><i className="feather-plus font-lg"></i></a></span>
                ...
                <div key={index}>
                    <div className="card w125 h200 d-block border-0 shadow-xss rounded-xxxl bg-gradiant-bottom overflow-hidden  mb-3 mt-0 me-3" style={{backgroundImage: `url("assets/images/${value.bgUrl}")`}}>
                        <div className="card-body d-block p-3 w-100 position-absolute bottom-0 text-center" >
