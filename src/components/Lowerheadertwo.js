                        ...
                        <div className="row">
                            <div className="col-lg-3 pe-0">
                                <div className="dropdown dropdown-right border-0">
                                    <Button onClick={()=>{this.handleModel()}} className="btn border-0 rounded-0 dropdown-toggle dropdown-toggle-white bg-warning ps-3"><i className="feather-align-left"></i> All Categories</Button>
                                ...
                                <div className="navbar navbar-expand-lg p-0">
                                    <div className="navbar-collapse collapse show" id="main_nav" >
                                        ...
                                        <ul className="navbar-nav ms-auto">
                                            <li className="nav-item text-grey-100 fw-500 font-xssss">Need help? Call Us : <a href="tel:03340005000" className="fw-700 text-white">+ 033 4000 5000</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>        
