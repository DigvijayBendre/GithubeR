...
class Header extends Component {
    ...
    render() {  
        ...
        return (
            <div className={`header-wrapper pt-4 pb-4 z-index-5 ovh d-none d-lg-block bg-white`}>
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12 d-flex">
                            <Link to="/"><img src="assets/images/logo1.jpg" alt="logo" className="logo" /></Link>
                            <div className="header-search ms-auto me-2 d-flex">
                                <Button onClick={()=>{this.handleModel()}} className="location me-3 bg-transparent border-0">
                                    ...
                                    <h4 className="fw-600 font-xssss mt-0 text-green mb-0 ls-0">Downtown .</h4>
                                </Button>
