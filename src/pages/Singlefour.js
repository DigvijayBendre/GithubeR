...
class Singlefour extends Component {
    render() {
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6">
                                <div className="product-card border-0">
                                    ...
                                    <div className="alert-warning border border-warning border-size-sm text-warning p-3 text-center w-100 font-xssss fw-700 rounded-6 mb-4">Deal of the Day</div>
