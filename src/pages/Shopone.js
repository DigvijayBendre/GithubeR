                            ...
                            <div className="col-lg-12">
                                <div className="card d-flex flex-wrap flex-row w-100 p-lg-5 p-4 border-0 bg-image-cover bg-image-center mb-3" style={{backgroundImage: `url("assets/images/slider-12.jpg")`}} >
                                    <div className="col-lg-5 col-md-12">
                                        <h2 className="fw-700 display1-size display1-sm-size ls-0 text-grey-900 mb-0">Choose the best <span className="text-current">ier way</span> of life</h2>
                            ...
                            <div className="col-lg-8">
                                <div className="row m-0">
                                    <div className="card d-flex flex-row justify-content-start p-3 bg-greylight border-0 mb-3">
                                        <a href="/shop-1" className="mt-1"><span className="feather-grid text-grey-600 font-xs"></span></a>
                                ...
                                <div className="row">
                                    <div className="col-lg-12 mt-5 mb-4">
                                        ...
                                        <ul className="pagination justify-content-center">
                                            <li className="page-item disabled"><a className="page-link" href="/shop-1"><i className="feather-chevron-left"></i></a></li>
                                            <li className="page-item active"><a className="page-link" href="/shop-1">1</a></li>
                                            <li className="page-item"><a className="page-link" href="/shop-1">2</a></li>
                                            <li className="page-item"><a className="page-link" href="/shop-1">3</a></li>
                                            <li className="page-item"><a className="page-link" href="/shop-1">4</a></li>
                                            <li className="page-item"><a className="page-link" href="/shop-1"><i className="feather-chevron-right"></i></a></li>
                                        </ul>
                                        </nav>
                                    </div>
                                </div>
