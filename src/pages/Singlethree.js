...
class Singlethree extends Component {
    render() {
        ...
        return (
            <Fragment> 
                ...
                <div className="product-wrapper product-card product-wrap md-mt-6">
                ...
                <div className="product-wrapper product-card pb-5 pt-5">
                    <div className="container">
                        <div className="row">
                            <div className="col-xl-4 col-lg-6 col-md-6">
                                ...
                                <h2 className="fw-700 text-grey-800 font-xxl ls-0 mt-0 mb-2 tag-name lh-3">Organic Wheat Maida</h2>
                                <div className="star d-inline text-left">
                                    <img src="assets/images/veg.png" alt="star" className="w-10 me-1 float-start me-1 float-start" />
                                ...
                                <p className="font-xssss fw-500 mt-3 text-grey-500 lh-24">Vivamus adipiscing nisl ut dolor dignissim semper. Nulla luctus malesuada tincidunt.</p>
                            </div>
                            <div className="col-xl-4 col-lg-6 col-md-6 sm-mb-3">
                                <h6 className="font-xl ls-3 fw-700 text-current float-start mt-0 mb-3"><span className="font-xssss text-grey-500">₹</span>49 <span className="tag-weight">500 gm</span></h6>
                                <div className="clearfix"></div>
                                <div className="cart-card d-flex border-0">
                                    ...
                                    <a href="/single-product-4" className="bg-current text-white rounded-6 btn-cart">ADD to Cart</a>    
                                </div>
                                <div className="share-card d-flex mt-xl-5 mt-3">
                                    <h5 className="fw-700 text-grey-800 me-3 mt-2 lh-26 font-xssss">Share :</h5>
                                    <a href="/single-product-4" className="btn-round btn-round-md ms-1 z-index-1 bg-facebook"><i className="ti-facebook text-white"></i></a>
                                    <a href="/single-product-4" className="btn-round btn-round-md ms-1 z-index-1 bg-twiiter"><i className="ti-twitter-alt text-white"></i></a>
                                    <a href="/single-product-4" className="btn-round btn-round-md ms-1 z-index-1 bg-linkedin"><i className="ti-linkedin text-white"></i></a>
                                    <a href="/single-product-4" className="btn-round btn-round-md ms-1 z-index-1 bg-instagram"><i className="ti-instagram text-white"></i></a>
                                </div>                        
                            </div>
                            <div className="col-xl-4 col-lg-6 col-md-6">
                                <h5 className="font-xssss fw-500 text-grey-500 mb-2 mt-2 lh-3"><b className="text-grey-700">Brand:</b> <a href="/single-product-4" className="text-current fw-600">Orgomart</a> </h5>
                                <h5 className="font-xssss fw-500 text-grey-500 mb-2 mt-2 lh-3"><b className="text-grey-700">Vendor:</b> <a href="/single-product-4" className="text-current fw-600">Local Store</a> </h5>
