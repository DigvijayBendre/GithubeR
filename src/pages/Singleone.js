...
class Singleone extends Component {
    render() {
        ...
        return (
            <Fragment> 
                <Headermob />
                <Upperheader className="bg-greylight" />
                <Header />
                <Lowerheader />
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6">
                                <div className="product-card border-0">
                                    ...
                                    <ul className="breadcrumb-link list-inline"><li className="list-inline-item"><a href="/">Home</a></li><li className="list-inline-item"><a href="/">Meats ; Seafood</a></li><li className="list-inline-item">Wheat  Maida</li></ul>
