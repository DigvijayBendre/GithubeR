...
class Forgottwo extends Component {
    render() {
        return (
            <Fragment>
                    ...
                    <div className="row min-vh-100">
                        ...
                        <div className="card shadow-lg border-0 ms-auto me-auto login-card mt-auto mb-auto zindex-100 rounded-10 theme-dark-bg">
                            <div className="card-body rounded-0 text-left">
                                <h2 className="fw-700 display1-size display2-md-size mb-4 mt-3 white-text">Change <br />your password</h2>                        
                                <form>
                                    ...
                                    <div className="form-check text-left mb-3">
                                        ...
                                        <label className="form-check-label font-xssss text-grey-500" htmlFor="exampleCheck4">Accept Term and Conditions</label>
                                    </div>
                                </form>
                                
                                <div className="col-sm-12 p-0 text-left mb-3">
                                    <div className="form-group mb-1"><a href="/loginone" className="text-center font-xsss style2-input text-white fw-600 bg-current border-0 p-0 ">Change Password</a></div>
